...
/* USER CODE BEGIN EFP */
extern void TIM16_Update_IRQ(void);
/* USER CODE END EFP */
...
#define RIGHT_STEPPER_EN_Pin GPIO_PIN_5
#define RIGHT_STEPPER_EN_GPIO_Port GPIOD
#define LEFT_STEPPER_EN_Pin GPIO_PIN_6
#define LEFT_STEPPER_EN_GPIO_Port GPIOD
#define RIGHT_STEPPER_DIR_Pin GPIO_PIN_7
#define RIGHT_STEPPER_DIR_GPIO_Port GPIOD
#define LEFT_STEPPER_DIR_Pin GPIO_PIN_3
#define LEFT_STEPPER_DIR_GPIO_Port GPIOB
#define RIGHT_STEPPER_STEP_Pin GPIO_PIN_4
#define RIGHT_STEPPER_STEP_GPIO_Port GPIOB
#define LEFT_STEPPER_STEP_Pin GPIO_PIN_5
#define LEFT_STEPPER_STEP_GPIO_Port GPIOB
